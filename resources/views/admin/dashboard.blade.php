...
<body class="bg-[#fcfcfd] text-slate-900" x-data="{ sidebarOpen: false }">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
        ...
        <nav class="flex-1 px-4 py-2 space-y-1 sidebar-scroll overflow-y-auto">
            ...
            <a href="#"
                class="sidebar-
                link active flex items-center px-4 py-2.5 rounded-xl font-semibold transition-all group">
                <i class="bi bi-grid-1x2-fill mr-3 text-lg"></i>
                Dashboard
            </a>

            <a href="{{ route('candidates.index') }}"
                class="sidebar-link flex items-center px-4 py-2.5 text-slate-500 rounded-xl transition-all group">
            ...
            <p class="pt-8 px-3 text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-4">
                Support & Admin
            </p>
        ...
        <div class="p-4 border-t border-slate-100">
            <form method="POST" action="{{ route('login') }}">
                <button
                    class="flex items-center w-full px-4 py-2.5 text-slate-500 hover:text-rose-600 rounded-xl transition-colors">
    ...
    <div class="lg:ml-64 min-h-screen flex flex-col">
        ...
        <!-- Top Sticky Header -->
        <header
            class="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-slate-200 px-4 lg:px-8 py-4 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex items-center gap-3 pl-4 border-l border-slate-100">
                    ...
                    <div
                        class="w-9 h-9 rounded-full bg-emerald-100 text-emerald-700 flex items-center justify-center font-bold border-2 border-white shadow-sm">
        ...
        <main class="p-4 lg:p-8 flex-1">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                ...
                <div
                    class="stat-card bg-white p-6 rounded-3xl border border-slate-200 shadow-sm transition-all hover:shadow-lg">
                    <div
                        class="icon-box w-12 h-12 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center mb-4 transition-transform">
                ...
                <div
                    class="stat-card bg-white p-6 rounded-3xl border border-slate-200 shadow-sm transition-all hover:shadow-lg">
                    <div
                        class="icon-box w-12 h-12 bg-amber-50 text-amber-600 rounded-2xl flex items-center justify-center mb-4 transition-transform">
                ...
                <div
                    class="stat-card bg-white p-6 rounded-3xl border border-slate-200 shadow-sm transition-all hover:shadow-lg">
                    <div
                        class="icon-box w-12 h-12 bg-emerald-50 text-emerald-600 rounded-2xl flex items-center justify-center mb-4 transition-transform">
                ...
                <div
                    class="stat-card bg-white p-6 rounded-3xl border border-slate-200 shadow-sm transition-all hover:shadow-lg">
                    <div
                        class="icon-box w-12 h-12 bg-rose-50 text-rose-600 rounded-2xl flex items-center justify-center mb-4 transition-transform">
            ...
            <div class="mb-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <a href="{{ route('candidates.create') }}"
                        class="group relative bg-emerald-600 p-6 rounded-[2rem] overflow-hidden transition-all hover:-translate-y-1 shadow-lg shadow-emerald-200">
                        <div class="relative z-10 flex flex-col justify-between h-full">
                            <div
                                class="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center mb-4 backdrop-blur-md">
                        ...
                        <i
                            class="bi bi-person-plus absolute -bottom-2 -right-2 text-6xl text-white/10 group-hover:scale-125 transition-transform"></i>
                    </a>

                    <!-- Standard Actions -->
                    <a href="{{ route('candidates.index') }}"
                        class="group bg-white p-6 rounded-[2rem] border border-slate-200 transition-all hover:border-emerald-300 hover:shadow-md flex flex-col justify-between">
                        <div
                            class="w-10 h-10 bg-slate-50 text-slate-600 rounded-xl flex items-center justify-center mb-4 group-hover:bg-emerald-50 group-hover:text-emerald-600 transition-colors">
                    ...
                    <a href="{{ route('interviews.index') }}"
                        class="group bg-white p-6 rounded-[2rem] border border-slate-200 transition-all hover:border-amber-300 hover:shadow-md flex flex-col justify-between">
                        <div
                            class="w-10 h-10 bg-slate-50 text-slate-600 rounded-xl flex items-center justify-center mb-4 group-hover:bg-amber-50 group-hover:text-amber-600 transition-colors">
                    ...
                    <a href="{{ route('admin.results') }}"
                        class="group bg-white p-6 rounded-[2rem] border border-slate-200 transition-all hover:border-blue-300 hover:shadow-md flex flex-col justify-between">
                        <div
                            class="w-10 h-10 bg-slate-50 text-slate-600 rounded-xl flex items-center justify-center mb-4 group-hover:bg-blue-50 group-hover:text-blue-600 transition-colors">
