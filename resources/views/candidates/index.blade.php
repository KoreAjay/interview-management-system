...
<body class="bg-[#fcfcfd] text-slate-900" x-data="{ sidebarOpen: false }">
    ...
    <div class="lg:ml-64 min-h-screen flex flex-col">
        ...
        <main class="p-4 lg:p-8 flex-1">
            ...
            <!-- Filters Section -->
            <div class="mb-10 bg-white p-6 rounded-[2rem] border border-slate-200 shadow-sm">
                ...
                <form method="GET" class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 items-end">
                    <div class="space-y-2">
                        <label class="text-[11px] font-bold text-slate-400 uppercase tracking-widest pl-1">From Date</label>
                        <div class="relative">
                            <i class="bi bi-calendar-event absolute left-4 top-1/2 -translate-y-1/2 text-slate-400"></i>
                            <input type="date" name="from" 
                                class="w-full pl-11 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all">
                        </div>
                    </div>

                    <div class="space-y-2">
                        <label class="text-[11px] font-bold text-slate-400 uppercase tracking-widest pl-1">To Date</label>
                        <div class="relative">
                            <i class="bi bi-calendar-check absolute left-4 top-1/2 -translate-y-1/2 text-slate-400"></i>
                    ...
                    <div>
                        <button type="submit" class="w-full md:w-auto px-8 py-2.5 bg-slate-900 text-white text-sm font-bold rounded-xl hover:bg-slate-800 transition-all shadow-lg shadow-slate-200">
                            Apply Filter
                        </button>
                    </div>
                </form>
